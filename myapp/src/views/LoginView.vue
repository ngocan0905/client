<template>
  <!-- component -->
  <div
    class="flex justify-center items-center w-full h-screen bg-cover bg-black"
  ...
  >
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col md:w-fit lg:w-1/3">
      <div class="mb-4">
        <label class="block text-gray-800 text-sm font-bold mb-2" for="username"> Email </label>
        <input
          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-800 outline-none"
          id="username"
          type="text"
      ...
      <div class="mb-6">
        ...
        <input
          class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-gray-800 mb-3 outline-none"
          id="password"
          type="password"
          placeholder="******************"
          v-model="password"
